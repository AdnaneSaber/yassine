...
export const TRANSITION_PERMISSIONS: Record<string, string[]> = {
  'SOUMIS->RECU': ['SYSTEM', 'ADMIN', 'SUPER_ADMIN'],
  'RECU->EN_COURS': ['SYSTEM', 'ADMIN', 'SUPER_ADMIN'],
  'RECU->REJETE': ['SYSTEM', 'ADMIN', 'SUPER_ADMIN'],
  'EN_COURS->ATTENTE_INFO': ['SYSTEM', 'ADMIN', 'SUPER_ADMIN'],
  'EN_COURS->VALIDE': ['SYSTEM', 'ADMIN', 'SUPER_ADMIN'],
  'EN_COURS->REJETE': ['SYSTEM', 'ADMIN', 'SUPER_ADMIN'],
  'ATTENTE_INFO->EN_COURS': ['SYSTEM', 'STUDENT', 'ADMIN', 'SUPER_ADMIN'],
  'ATTENTE_INFO->REJETE': ['SYSTEM', 'ADMIN', 'SUPER_ADMIN'],
